function SongController(_savedSongs, ServiceArgument){
    ...
    $.get('-userSession.html?' + Date.now(), (data)=>{
...
// ADD/REMOVE SONGS TO YOUR LIBRARY
            $('.page-container').on('click', '.add-btn', function goodie(a){
                ...
                if(!(thisChild.className.includes("fa-heart-o")) && !($(this)[0].className.includes('fa-heart-o'))){
                    $(thisChild).addClass("fa-heart-o")
                    $(thisChild).removeClass('fa-heart')
                    console.log("SUBTRACT")
                    songService.destroySong(songService.getsongLibrary()[id]);
                    return;
                }else if(thisChild.className.includes("fa-heart-o") || $(this)[0].className.includes('fa-heart-o')){
                    $(thisChild).addClass("fa-heart")
                    $(thisChild).removeClass('fa-heart-o')
                    console.log("ADD")
...
// DRAW SONGS TO PAGE
        function drawSongs(songList){
            ...
            document.getElementById('songs').innerHTML = songList.map((a)=>{
                ...
                return !(a.preview)? "" : `
                    ...
                    <div class="add-btn control" songid='${a.id}'><i class="fa ${(a.inMyLibrary)? "fa-heart" : "fa-heart-o"} fa-3x" songid='${a.id}'></i></div>\
 ...
 <div class="playlist-list-container">
    <div class="heading-container">
      <span class="txt title">Add to Existing |</span>
      <span class="txt title">Create New</span>
    </div>
    <div class="playlist-body-container">
      <div class="playlist-body">
        <div class="playlist">
          <div class="album-art-container">
            <img src="http://is2.mzstatic.com/image/thumb/Music/v4/2e/84/07/2e84077a-8251-9f21-89c6-172c58d4ddda/source/400x400bb.jpg" alt="">
          </div>
          <div class="playlist-name-container">
            <span class="txt li">My Playlist</span>
          </div>
        </div>
        <div class="playlist">
          <div class="album-art-container">
